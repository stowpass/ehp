...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Sistema EHP - </b>Login</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Entre com seus dados para iniciar uma Session</p>

    <form action="<?php echo site_url('usuarios/verificar');?>" method="post">
      <div class="form-group has-feedback">
        <input id="usuario" name="usuario" type="email" class="form-control" placeholder="Usuario / Email">
